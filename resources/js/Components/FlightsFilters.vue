  ...
  <div class="flex justify-between items-center">
    <div>
      ...
      <Button
        ...
        :disabled="activeFilter === 'future'"
      >
        Future
      </Button>
      <Button
        @click="() => filterResults('filter', 'past')"
    ...
    <div class="flex justify-center">
      <div class="flex items-center">
        ...
        <Select
          class="mr-6"
          @change="(event) => filterResults('from', event.target.value)"
        >
          <option value="">All</option>
          <option
            :selected="airport.id == activeFrom"
            :value="airport.id"
            :key="airport.id"
            v-for="airport in airports"
          >
            {{ airport.full_name }} ({{ airport.code_name }})
          </option>
        </Select>
      </div>
      <div class="flex items-center">
