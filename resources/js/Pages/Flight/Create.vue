          ...
          <div class="mx-8 mb-6">
            <form @submit.prevent="createFlight" ref="createFlightForm">
              ...
              <div class="flex items-start">
                <div class="w-1/2">
                  <div class="flex items-center">
                    <label class="mr-4 w-24 font-semibold" for="departure-airport"> Airport: </label>
                ...
                <div class="ml-16">
                  <div class="flex items-center">
                    <label class="mr-4 w-24 font-semibold" for="departure-time"> Date & Time: </label>
                    <flat-pickr class="border border-gray-200 py-2 px-4 bg-gray-100 rounded-md" id="departure-time" v-model="form.departureDate" :config="flatPickrConfig"></flat-pickr>
                  </div>
              ...
              <div class="flex items-start">
                <div class="w-1/2">
                  <div class="flex items-center">
                    <label class="mr-4 w-24 font-semibold" for="arrival-airport"> Airport: </label>
                ...
                <div class="ml-16">
                  <div class="flex items-center">
                    <label class="mr-4 w-24 font-semibold" for="arrival-time"> Date & Time: </label>
                    <flat-pickr class="border border-gray-200 py-2 px-4 bg-gray-100 rounded-md" id="arrival-time" v-model="form.arrivalDate" :config="flatPickrConfig"></flat-pickr>
                  </div>
              ...
              <div class="flex items-start">
                <div class="w-1/2">
                  <div class="flex items-center">
                    <label class="mr-4 w-24 font-semibold" for="price"> Price: </label>
                ...
                <div class="ml-16">
                  <div class="flex items-center">
                    <label class="mr-4 w-24 font-semibold" for="capacity"> Capacity: </label>
